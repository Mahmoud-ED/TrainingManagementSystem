    ...
    public partial class m1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseClassifications", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseParent", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApprovalFileUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlanHeaders", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    NotionalNo = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChiefName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    ChiefTitle = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Organizitions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Organizitions_Categories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CourseClassificationId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    LevelId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    Code = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Description = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    CourseParentId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    Created = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Modified = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Courses_CourseClassifications_CourseClassificationId",
                        column: x => x.CourseClassificationId,
                        principalTable: "CourseClassifications",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Courses_CourseParent_CourseParentId",
                        column: x => x.CourseParentId,
                        principalTable: "CourseParent",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Trainers_Qualifications_QualificationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Trainees_Organizitions_OrganizationId",
                        column: x => x.OrganizationId,
                        principalTable: "Organizitions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Trainees_Qualifications_QualificationId",
                        column: x => x.QualificationId,
                        principalTable: "Qualifications",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Trainees_Specializations_SpecializationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CourseDetails_CourseTypes_CourseTypeId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CourseDetails_Locations_LocationId",
                        column: x => x.LocationId,
                        principalTable: "Locations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CourseDetails_Statuses_StatusId",
                        column: x => x.StatusId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CourseTrainees_CourseDetails_CourseDetailsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseDetails_LocationId",
                table: "CourseDetails",
                column: "LocationId");

            migrationBuilder.CreateIndex(
                name: "IX_CourseDetails_StatusId",
                table: "CourseDetails",
                column: "StatusId");

            migrationBuilder.CreateIndex(
                name: "IX_Courses_CourseClassificationId",
                table: "Courses",
                column: "CourseClassificationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseTrainees_CourseDetailsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Organizitions_CategoryId",
                table: "Organizitions",
                column: "CategoryId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Trainees_OrganizationId",
                table: "Trainees",
                column: "OrganizationId");

            migrationBuilder.CreateIndex(
                name: "IX_Trainees_QualificationId",
                table: "Trainees",
                column: "QualificationId");

            migrationBuilder.CreateIndex(
                name: "IX_Trainees_SpecializationId",
                table: "Trainees",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Trainers_QualificationId",
                table: "Trainers",
                column: "QualificationId");
